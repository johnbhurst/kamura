...
new IText2Builder(new FileOutputStream("build/examples/in_action/chapter08/FileSizeComparisonNotEmbedded.pdf")).document() {
...
new IText2Builder(new FileOutputStream("build/examples/in_action/chapter08/FileSizeComparisonEmbedded1.pdf")).document() {
...
new IText2Builder(new FileOutputStream("build/examples/in_action/chapter08/FileSizeComparisonEmbedded2.pdf")).document() {
  BaseFont bf_embedded = BaseFont.createFont(windowsFontPath("comic.ttf"), BaseFont.CP1252, BaseFont.EMBEDDED)
  Font font_embedded = new Font(bf_embedded, 12)
