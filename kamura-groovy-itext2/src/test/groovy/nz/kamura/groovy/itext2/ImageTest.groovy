...
package nz.kamura.groovy.itext2
...
class ImageTest extends AbstractPDFBuilderTestCase {
  ...
  void testOk() {
    defaultBuilder.document() {
      ...
      def img3 = image(url: new URL("https://www.apache.org/img/asf_logo.png"), init: {it.scalePercent(50f, 100f)})
      assert img1.width == 355
      assert img2.width == 355
      assert img2.scaledWidth == 355 / 4
      assert img3.width == 429
      assert img3.scaledWidth == 429 / 2
      assert img3.height == 175
    }
  }
}
